...
<div class="max-w-5xl mx-auto px-6 py-8">
    ...
    <form action="<?= url('pages/students/update.php') ?>" method="POST"enctype="multipart/form-data" class="bg-white rounded-xl shadow">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                    ...
                    <div class="border rounded-lg p-5">
                        ...
                        <img
                            id="previewImage"
                            src="<?= !empty($student['picture']) ? asset($student['picture']) : asset('assets/images/no-image.png') ?>"
                ...
                <div>
                    ...
                    <div class="mb-5">
                        ...
                        <input
                            ...
                            value="<?= CUSTOM_DATE_TIME($student['created_at']) ?>"
                            readonly>
        ...
        <div class="border-t bg-gray-50 px-6 py-4 flex justify-end gap-3">
            ...
            <a
                href="<?= url('pages/students/index.php') ?>"
